...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML
    public AnchorPane paneNonStatic,listPaneNonStatic,rootNonStatic, topPaneNonStatic, pointPaneNonStatic;
    ...
    @FXML
    public Button zoomInButton, zoomOutButton, newNodeButton;
    @FXML
    ...
    @FXML
    public ToolBar toolBarNonStatic;
    
    @FXML
    public static Canvas canvas;
    
    @FXML
    public Canvas canvasNonStatic;
    ...
    public void initialize(URL url, ResourceBundle rb) {
          ...
          canvas = canvasNonStatic;
          pane = paneNonStatic;
          listPane = listPaneNonStatic;
          toolBar = toolBarNonStatic; 
          root = rootNonStatic;
          topPane = topPaneNonStatic;
          pointPane = pointPaneNonStatic;
//        canvas = new Canvas();
////        fadeInTransition();
////        Side.decorateSidePane();
////         GraphicsContext gca =   canvas.getGraphicsContext2D();
    ...
    @FXML
    public  JFXButton  selectBtn, btn0,btn1, btn2, btn3, btn4, btn5, btn7,btn8, btn11, btn12, area,clear,midPointButton;
    public  MenuItem segmentItem, straightLineItem, perpendicularLineItem, perpendicularBisectorItem;
    @FXML
    public  ContextMenu contextMenu01, contextMenu02;
...
//            
    ...
    public void clear() {
//        System.out.println("FXML : " + gc==null);
        page.redraw(gc);
    }
